          ...
          <li class="nav-item dropdown">
            ...
            <li class="nav-item nav-profile dropdown">
              ...
              <div class="nav-profile-img">
                  <img src="{{ asset('public/admin/images/profile/' . auth()->user()->image) }}" alt="image">
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                  ...
                  <a class="dropdown-item" href="{{ route('admin.adminPassword') }}">
                  ...
                  <form action="{{ route('admin.adminLogout') }}" method="GET">
                  @csrf
                  ...
                  <a class="dropdown-item" href="{{ route('admin.adminLogout') }}" style="background:transparent;">
